---
title: "Marktsegmentierung & Zielgruppen"
...
fallbeispiel:
  ...
  musterloesung: |
    Demografisch: Alter ab 50 Jahren. Sozioökonomisch: überdurchschnittliches
...
pruefungsfrage:
  frage: |
    Ein Kollege schlägt vor, einfach „alle Personen, die gerne shoppen" als Zielgruppe
    zu definieren.
...
Der Gesamtprozess folgt dem **STP-Marketing**: **S**egmentation (Markt aufteilen) → **T**argeting (Zielgruppen auswählen) → **P**ositioning (Leistung in der Zielgruppe positionieren).
