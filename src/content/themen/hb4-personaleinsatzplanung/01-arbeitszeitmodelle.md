---
title: "Arbeitszeitmodelle & Schichtplanung"
handlungsbereich: "hb4"
themengruppe: "Personaleinsatzplanung"
order: 1
description: "KAPOVAZ als kapazitätsorientierte variable Arbeitszeit, Schichtarbeit sowie die besondere Berücksichtigung schwerbehinderter Mitarbeiter in der Personaleinsatzplanung."
merksatz: |
...
fallbeispiel:
  ...
  aufgabe: |
    Schlagen Sie ein geeignetes Arbeitszeitmodell vor und erläutern Sie dessen
    Grundprinzip.
  musterloesung: |
    Geeignet ist die kapazitätsorientierte variable Arbeitszeit (KAPOVAZ). Bei diesem
    Modell wird der Personaleinsatz nicht starr geplant, sondern kurzfristig an den
    tatsächlichen Arbeitsanfall angepasst: Bei erhöhtem Arbeitsanfall werden mehr
    Mitarbeiter eingeplant, bei geringem Arbeitsanfall entsprechend weniger. Diese
    Planung erfolgt typischerweise sehr kurzfristig, sodass FRESHBOX auf die tatsächliche
    Bestelllage reagieren kann, statt eine für alle Tage gleich hohe (und damit an
...
pruefungsfrage:
  frage: |
    ...
    Arbeitgeber.
    b) Was ist bei der Personaleinsatzplanung im Hinblick auf schwerbehinderte
    Mitarbeiter besonders zu berücksichtigen?
    c) Nennen Sie einen Grund, warum klassische Schichtarbeit im Marketingbereich selten
    zur Anwendung kommt, anders als etwa im Krankenhaus.
  loesungsweg:
    - |
      KAPOVAZ (kapazitätsorientierte variable Arbeitszeit) passt die Anzahl der
      eingeplanten Mitarbeiter kurzfristig an den tatsächlichen Arbeitsanfall an. Vorteil
      für den Arbeitgeber: Personalkosten entstehen nur in dem Umfang, wie tatsächlich
      Arbeit anfällt, statt eine durchgehend gleich hohe Personalstärke vorzuhalten.
    - |
      Die Arbeitsbedingungen müssen entsprechend gestaltet werden, und bei besonderen
      Planungen wie Nacht- oder Mehrarbeit kann sich der schwerbehinderte Mitarbeiter auf
      eigenen Antrag davon befreien lassen – dies ist bei der Personaleinsatzplanung
      aktiv zu berücksichtigen.
    - |
      Schichtarbeit wird typischerweise dort eingesetzt, wo eine Stelle rund um die Uhr
      besetzt sein muss (z. B. 24-Stunden-Schicht im Krankenhaus). Im Marketingbereich
      besteht in der Regel kein Erfordernis einer durchgehenden Besetzung außerhalb der
      üblichen Geschäftszeiten, weshalb Schichtarbeit hier selten angewendet wird.
wiederholungTage: 5
---
