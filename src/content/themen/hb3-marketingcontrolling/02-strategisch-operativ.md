---
title: "Strategische & operative Marketingprozesse abstimmen"
...
fallbeispiel:
  ...
  aufgabe: |
    Erläutern Sie anhand des Managementkreislaufs, an welcher Stelle die Abstimmung
    zwischen strategischer und operativer Ebene hier fehlt.
  musterloesung: |
    Der Managementkreislauf (Zielbildung → Planung → Ausführung → Kontrolle) ist
...
pruefungsfrage:
  ...
  loesungsweg:
    - |
      a) Zielbildung, Planung, Ausführung (Realisation), Kontrolle – durchzogen von der
...
**Zielbildung** → **Planung** → **Ausführung (Realisation)** → **Kontrolle** → zurück zur Zielbildung
