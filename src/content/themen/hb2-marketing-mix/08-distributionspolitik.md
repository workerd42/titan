...
fallbeispiel:
  ...
  aufgabe: |
    Empfehlen Sie eine Distributionsbreite (intensiv, selektiv oder exklusiv) und
    begründen Sie die Wahl unter Berücksichtigung des Markenimages.
  musterloesung: |
    Eine selektive Distribution ist hier am sinnvollsten: Das Produkt soll zwar
...
pruefungsfrage:
  ...
  loesungsweg:
    - |
      a) Direktvertrieb. Vorteil: volle Kontrolle über Preisgestaltung, Markenauftritt und
