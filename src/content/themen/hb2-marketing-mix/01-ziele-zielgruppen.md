---
title: "Marketingziele und Zielgruppenanalyse"
...
definitionen:
  - begriff: "Oberziel (Unternehmensziel)"
    definition: "Übergeordnetes Ziel des Unternehmens, z. B. Gewinnmaximierung, Marktführerschaft, Nachhaltigkeit. Alle untergeordneten Ziele müssen darauf einzahlen."
  - begriff: "Marketingziele"
    definition: "Aus den Unternehmenszielen abgeleitete Ziele für den Marketingbereich, z. B. Marktanteilssteigerung, Bekanntheitssteigerung, Kundenzufriedenheit."
  - begriff: "Zielgruppe"
    definition: "Abgegrenzte Gruppe von Personen oder Organisationen, an die Marketingmaßnahmen gezielt gerichtet werden. Definiert durch demografische, psychografische und verhaltensbezogene Merkmale."
  - begriff: "SMART-Kriterien"
    definition: "Anforderungen an operationale Ziele: Spezifisch, Messbar, Akzeptiert/Attraktiv, Realistisch, Terminiert."
  - begriff: "Psychografische Merkmale"
    definition: "Innere Eigenschaften der Zielgruppe: Werte, Einstellungen, Lebensstil, Kaufmotive, Persönlichkeit."
  - begriff: "Demografische Merkmale"
    definition: "Äußere, objektiv messbare Eigenschaften: Alter, Geschlecht, Einkommen, Bildung, Familienstand, Wohnort."
...
fallbeispiel:
  ...
  aufgabe: |
    ...
    und beschreiben Sie die primäre Zielgruppe.
  musterloesung: |
    Ziel 1: Bekanntheit — 15 % Markenbekanntheit in der Zielgruppe bis 31.12. (Messung: Tracking-Studie).
    Ziel 2: Absatz — 5.000 Einheiten in den ersten 6 Monaten verkaufen.
    Ziel 3: Kundenzufriedenheit — NPS ≥ 40 bis Ende des Geschäftsjahres.
    Zielgruppe: Frauen, 25–40 Jahre, mittleres bis hohes Einkommen, Fitnessstudio-affin,
    Nachhaltigkeitsbewusstsein, urban, aktiver Lebensstil.

pruefungsfrage:
  frage: |
    Was sind SMART-Ziele und warum sind sie für das Marketing essenziell?
    Formulieren Sie ein SMART-Marketingziel für die Einführung eines neuen Produkts.
  loesungsweg:
