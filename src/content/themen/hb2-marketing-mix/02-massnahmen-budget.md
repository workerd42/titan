---
title: "Marketingmaßnahmen & Budgetplanung"
...
fallbeispiel:
  situation: |
    Die KLARTEXT Verlagsgruppe hatte im letzten Jahr einen Umsatzrückgang von 12 %. Der
  ...
  musterloesung: |
    Die Methode „Budgetierung nach Umsatz" hat genau diesen Schwachpunkt: Sie wirkt
...
pruefungsfrage:
  frage: |
    Die KLARTEXT Verlagsgruppe diskutiert intern, ob die Budgetplanung künftig top-down
  ...
  loesungsweg:
    - |
      a) Top-down: Die Marketingleitung gibt verbindliche Budgetvorgaben vor, die von den
