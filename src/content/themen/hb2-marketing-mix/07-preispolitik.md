...
fallbeispiel:
  ...
  musterloesung: |
    Eine Skimmingstrategie (Hochpreisstrategie) ist hier sinnvoll: Da es keine direkten
...
pruefungsfrage:
  frage: |
    Ein Wettbewerber bringt sechs Monate später eine ähnliche LED-Designlampe deutlich
  ...
  loesungsweg:
    - |
      a) Penetrationsstrategie (Niedrigpreisstrategie). Ziel ist es, durch einen niedrigen
