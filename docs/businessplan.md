...
> ergänzen** = braucht deine echten Angaben (Zahlen, Team, Rechtsform) — bewusst
> nicht erfunden. 💡 = mein Vorschlag/Empfehlung zur Entscheidung.
...
Eine webbasierte Lernplattform (SaaS) für die IHK-Fachwirt-Vorbereitung mit fünf
Nutzungsmodi: **Entdecken** (geführte 4-Phasen-Kapitel: Verstehen → Merken →
Anwenden → Prüfen), **Interaktive Module** (Werkzeuge wie SWOT, Deckungsbeitrag,
Nutzwertanalyse), **Übungsbereich**, **IHK-Testformat** und **Lernzettel**
(Karteikarten/Begriffe).
...
- **Produkt/Tech:** moderne, schnelle Web-Architektur (Astro, Postgres, echtes
  Login-Gate, Rollen/Admin), interaktive Werkzeuge, durchdachte UX/Animation.
- **Didaktisches Konzept:** die 4-Phasen-Methodik + Artefakt-Baukasten (inhaltlich
  belegt aus den IHK-Handlungsbereichen und Lehrbüchern, `docs/quellen/`).
- **Aufzubauen:** Content-Tiefe/-Aktualität über weitere Fachwirte, Vertrieb zu
  Bildungsträgern, ggf. Team. 📝 *Team-Fähigkeiten ergänzen.*
...
### Produktion (Kernaktivitäten) — Wie entsteht dein Angebot?

- **Selbst:** Produktentwicklung (Plattform/Engine), didaktisches Konzept,
  Content-Kuratierung, Betrieb (self-hosted, EU/DE).
- **Partner/zugekauft:** Fachautor:innen (Content), Infrastruktur-Dienste, ggf.
  KI-Modell.
- **Prozess-Differenzierung:** strikte Trennung **Engine (Software) ↔ Content-Packs
  (IHK-Daten)** → neue Fachwirte ohne Code-Änderung ausrollbar (Skalierungshebel).
